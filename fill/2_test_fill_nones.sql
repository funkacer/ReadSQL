...
\df f = {['SPOTREBA_MWH_AKTUALNI_PLYN', 'SPOTREBA_MWH_AKTUALNI_EE']:float.};
...
\df n = {['GENDER_TXT','TITLE_ACA1T','VEK', 'ZZDEATHDT', 'BPCONTFCT_ORG',
...
'WU_branch', 'WU_distance', 'WU_duration', 'id_p', 'id']:0};
...
\df n = {['GENDER_TXT','TITLE_ACA1T']: "#Chybí", 'VEK', ['ZZDEATHDT' 'BPCONTFCT_ORG'],
